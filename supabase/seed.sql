-- Development-only Layer 3 examples. Values are GBP pence (integer minor units).
...
insert into public.rooms (id, property_id, room_type_id, number)
values (
...
set room_rate_cents = 150000,
    tax_cents = 18000
where booking_room_id = '10000000-0000-0000-0000-000000000081'
  and stay_date = date '2026-09-10';

update public.booking_room_nights
set room_rate_cents = 120000,
    tax_cents = 14400
where booking_room_id = '10000000-0000-0000-0000-000000000082';

update public.booking_room_nights
set room_rate_cents = 140000,
    tax_cents = 16800
where booking_room_id = '10000000-0000-0000-0000-000000000083';
...
where f.booking_id = '10000000-0000-0000-0000-000000000071';
...
select
  ...
  134400
from public.folios f
where f.booking_id = '10000000-0000-0000-0000-000000000072';
...
select
  ...
  156800
from public.folios f
where f.booking_id = '10000000-0000-0000-0000-000000000073';
...
where description = 'Minibar snacks';
...
select
  ...
  date '2026-09-10',
  'reversal',
  'Reversal: Incorrect parking charge',
  quantity,
  unit_amount_cents,
  net_amount_cents,
  tax_amount_cents,
  ...
  id
from public.folio_items
where description = 'Incorrect parking charge';

-- This unauthenticated Layer 3 seed intentionally uses a non-cash payment.
-- Phase 4 cash payments must be posted through an authenticated open shift.
